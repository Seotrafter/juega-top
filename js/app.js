...
*/    var _suppressOverwrites, _reverting, _context, _globalTimeline, _win, _coreInitted, _doc, _coreReady, _lastRenderedFrame, _quickTween, _tickerActive, _config = {
    ...
    Tween.version = Timeline.version = gsap_core_gsap.version = "3.12.7";
    _coreReady = 1;
    _windowExists() && _wake();
...
*/
    ...
    ScrollToPlugin.config = function(vars) {
        ScrollToPlugin_config || ScrollToPlugin_initCore() || (ScrollToPlugin_config = ScrollToPlugin_gsap.config());
        for (var p in vars) ScrollToPlugin_config[p] = vars[p];
    };
    ...
    document.querySelectorAll('a[href^="#"]').forEach((anchor => {
        anchor.addEventListener("click", (function(e) {
            ...
            if (target) gsapWithCSS.to(window, {
                duration: 1,
                scrollTo: {
                    y: target,
                    offsetY: 80
    ...
    class Cursor {
        constructor() {
            ...
            this.cursorInner = document.getElementById("cursor_inner");
            this.mouseX = 0;
            this.mouseY = 0;
            this.cursorX = 0;
            this.cursorY = 0;
        ...
        init() {
            ...
            gsapWithCSS.set([ this.cursor, this.cursorInner ], {
                xPercent: -50,
                yPercent: -50
            });
            document.addEventListener("mousemove", (e => {
                ...
                gsapWithCSS.to(this.cursorInner, {
                    duration: .1,
                    x: this.mouseX,
                    y: this.mouseY
                });
    ...
    class VideoPopup {
        constructor() {
            this.popup = document.querySelector("[data-video-popup]");
            this.playerContainer = document.querySelector("[data-video-popup-player]");
            this.triggers = document.querySelectorAll("[data-video-popup-trigger]");
            this.closeBtn = document.querySelector("[data-video-popup-close]");
            this.overlay = document.querySelector("[data-video-popup-overlay]");
        ...
        init() {
            ...
            this.playerContainer?.addEventListener("click", (e => this.handleVideoClick(e)));
        }
        handleVideoClick(e) {
            if (!this.videoPlayer || e.target !== this.videoPlayer) return;
            if ("playsInline" in this.videoPlayer) this.videoPlayer.playsInline = true;
        ...
        open(videoSrc) {
            if (this.currentVideoSrc === videoSrc && this.popup.classList.contains("active")) return;
    ...
    class CustomCursor {
        constructor() {
            ...
            this.links = document.querySelectorAll("a, button, [data-cursor]");
        ...
        addEventListeners() {
            ...
            this.links.forEach((link => {
                link.addEventListener("mouseenter", (() => this.handleLinkHover(true)));
                link.addEventListener("mouseleave", (() => this.handleLinkHover(false)));
            }));
        ...
        handleLinkHover(isEntering) {
            this.cursorScale = isEntering ? 1.5 : 1;
            document.body.classList.toggle("cursor-hover", isEntering);
        }
        updateCursor() {
            ...
            this.cursorRotation = this.isMouseMoving ? angle : this.cursorRotation * .8;
            this.cursor.style.transform = `translate(${this.cursorX}px, ${this.cursorY}px) rotate(${this.cursorRotation}deg) scale(${this.cursorScale})`;
            this.cursorInner.style.transform = `translate(${this.mouseX}px, ${this.mouseY}px) scale(${this.cursorScale * .5})`;
        }
        startAnimation() {
            const animate = () => {
                this.updateCursor();
    ...
    class ScrollToTop {
        ...
        updateButtonState() {
            ...
            const progress = Math.min(scrolled / (document.documentElement.scrollHeight - viewportHeight) * 360, 360);
            this.button.style.setProperty("--progress", `${progress}deg`);
            this.button.classList.toggle("visible", scrolled > viewportHeight / 2);
        }
    }
